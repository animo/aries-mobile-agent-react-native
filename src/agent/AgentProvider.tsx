import { Agent, HttpOutboundTransporter, InitConfig, PollingInboundTransporter } from 'aries-framework'
import { ReactNativeFileSystem } from 'aries-framework/build/src/storage/fs/ReactNativeFileSystem'
import React, { useContext, useEffect, useState } from 'react'
import indy from 'rn-indy-sdk'

const GENESIS = `{"reqSignature":{},"txn":{"data":{"data":{"alias":"Node1","blskey":"4N8aUNHSgjQVgkpm8nhNEfDf6txHznoYREg9kirmJrkivgL4oSEimFF6nsQ6M41QvhM2Z33nves5vfSn9n1UwNFJBYtWVnHYMATn76vLuL3zU88KyeAYcHfsih3He6UHcXDxcaecHVz6jhCYz1P2UZn2bDVruL5wXpehgBfBaLKm3Ba","blskey_pop":"RahHYiCvoNCtPTrVtP7nMC5eTYrsUA8WjXbdhNc8debh1agE9bGiJxWBXYNFbnJXoXhWFMvyqhqhRoq737YQemH5ik9oL7R4NTTCz2LEZhkgLJzB3QRQqJyBNyv7acbdHrAT8nQ9UkLbaVL9NBpnWXBTw4LEMePaSHEw66RzPNdAX1","client_ip":"138.197.138.255","client_port":9702,"node_ip":"138.197.138.255","node_port":9701,"services":["VALIDATOR"]},"dest":"Gw6pDLhcBcoQesN72qfotTgFa7cbuqZpkX3Xo6pLhPhv"},"metadata":{"from":"Th7MpTaRZVRYnPiabds81Y"},"type":"0"},"txnMetadata":{"seqNo":1,"txnId":"fea82e10e894419fe2bea7d96296a6d46f50f93f9eeda954ec461b2ed2950b62"},"ver":"1"}
...
const AgentProvider = (props: AgentContextProps) => {
  ...
  const initAgent = async (): Promise<void> => {
    const agentConfig: InitConfig = {
      label: 'eSSIF Demo',
      walletConfig: { id: 'wallet12' },
      walletCredentials: { key: '1234' },
      autoAcceptConnections: true,
      poolName: 'test-103339',
      genesisTransactions: GENESIS,
      fileSystem: new ReactNativeFileSystem(),
      indy,
      mediatorUrl: 'https://mediator.animo.id',
      ...props.agentConfig,
    }
